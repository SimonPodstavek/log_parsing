...
def upload_records(satisfying_records:list, total_number_of_records:int, records_with_invalid_expression:int) -> None:

    #check if there are any records to be uploaded
    number_of_satisfying_records = len(satisfying_records)
    ...
    print("Spracované záznamy: {} / {} \n".format(number_of_satisfying_records ,total_number_of_records))
    print("Nespracované záznamy: {} z toho platných: {}\n".format(total_number_of_records-number_of_satisfying_records, total_number_of_records-number_of_satisfying_records-records_with_invalid_expression))
    print("Úspešnosť spracovania platných záznamov: {}%: \n".format(100*number_of_satisfying_records/(total_number_of_records-records_with_invalid_expression)))
